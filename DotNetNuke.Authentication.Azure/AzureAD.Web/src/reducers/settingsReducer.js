    ...
    switch (action.type) {
        case ActionTypes.RETRIEVED_SETTINGS:
            return { ...state,
                ...
                autoMatchExistingUsers: action.data.autoMatchExistingUsers,
                ...
                graphUseCustomParams: action.data.graphUseCustomParams,
                jwtAudiences: action.data.jwtAudiences,
                roleSyncEnabled: action.data.roleSyncEnabled,
                userSyncEnabled: action.data.userSyncEnabled,
